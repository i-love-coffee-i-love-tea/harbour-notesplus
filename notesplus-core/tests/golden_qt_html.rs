...
///   UPDATE_GOLDEN=1 cargo test -p notesplus-core -- golden
///
/// Without UPDATE_GOLDEN, tests assert byte-identical output against saved files.
use notesplus_core::html::qt_html::{QtRenderOptions, QtThemeColors, render_qt_block, render_qt_spans, highlight_search_terms};
use notesplus_core::inline::parse_inline;
...
fn assert_or_update_golden(name: &str, actual: &str) {
    ...
    assert_eq!(
        expected, actual,
        "\n\nGolden file mismatch for '{}'.\nTo update: UPDATE_GOLDEN=1 cargo test -p notesplus-core -- golden\n\nExpected:\n{}\n\nActual:\n{}\n",
