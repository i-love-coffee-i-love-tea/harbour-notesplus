//! TLS support and self-signed certificate generation for Fishdoc embedded web server.
...
impl Default for TlsOptions {
    fn default() -> Self {
        Self {
            common_name: "Fishdoc Web Server".to_string(),
            organization: "Fishdoc".to_string(),
