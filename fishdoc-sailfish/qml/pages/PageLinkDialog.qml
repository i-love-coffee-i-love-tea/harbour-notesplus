    ...
    SilicaFlickable {
        ...
        Column {
            ...
            SearchField {
                id: searchField
                width: parent.width
                placeholderText: "Search page to link..."
                text: ""
                onTextChanged: {
                    loadPages(text)
            ...
            TextField {
                id: linkDisplayField
                width: parent.width
                label: "Link display text (optional)"
                placeholderText: pageLinkDialog.selectedText.length > 0 ? pageLinkDialog.selectedText : (pageLinkDialog.targetPageTitle.length > 0 ? pageLinkDialog.targetPageTitle : "Text to show for link")
            ...
            SectionHeader {
                text: searchField.text.trim().length > 0 ? "Matching Pages" : "All Pages"
            }
            ...
            BackgroundItem {
                ...
                Row {
                    ...
                    Column {
                        ...
                        Label {
                            text: "Create & Link: " + searchField.text.trim()
                            color: Theme.highlightColor
                        ...
                        Label {
                            text: "Links to a new page '" + (searchField.text.trim().indexOf(".adoc") === -1 ? (searchField.text.trim() + ".adoc") : searchField.text.trim()) + "'"
